 ...
 *
 * Essa funcao inicializa um instacia da estrutura documento e o vetor de
 ...
 *
 * Essa funcao deleta o array de documentos, cada documento, e o vetor de
 * palavras
 *
 * @param documents Array de documentos
 * @param numDocs Numero de documentos
 ...
 *
 * Essa funcao processa cada um dos documentos, coloca seu conteudo na estrutura
 * Doc e retorna um array com o conteudo de todos os documentos solicitados
 *
